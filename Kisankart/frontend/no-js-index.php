...
<body>
    ...
    <header class="bg-light py-5">
        <div class="container px-5">
            <div class="row gx-5 align-items-center">
                ...
                <div class="col-lg-6">
                    <img src="assets/hero-image.jpg" class="img-fluid rounded" alt="Farm fresh vegetables">
                </div>
            </div>
        </div>
    </header>
                ...
                <div class="col-md-6 col-lg-4 mb-4">
                    <div class="card product-card h-100">
                        <a href="product-details.html?id=5" class="text-decoration-none">
                            ...
                            <img src="https://via.placeholder.com/300x200?text=No+Image" class="card-img-top product-image" alt="Fresh Onions">
                            <div class="card-body">
    ...
    <!-- No JavaScript is loaded in this version -->
</body>
</html>
